        ...
        <form method="post" id="adForm">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formtable">
                ...
                <tr>
                    <td>图片</td>
                    <td>
                        <div class="bg-cover" id="image_preview" style="width: 100px; height: 100px; background-color: #f5f5f5; display: block; background-image: url({{image_url($addata['image']['image'])}})">
                        </div>
