...
@section('content')
                ...
                <div class="list-box">
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="content">
                                <input type="text" class="input-text" name="work[start_time]" id="start_time" value="{{date('Y-m-d',$work['start_time'])}}" placeholder="入职时间">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="label">离职时间</div>
                            <div class="content">
                                <input type="text" class="input-text" name="work[end_time]" id="end_time" value="{{date('Y-m-d',$work['end_time'])}}" placeholder="离职时间">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        var month2 = date2[1]?date2[1]:'2';
        var day2 = date2[2]?date2[2]:'2';
